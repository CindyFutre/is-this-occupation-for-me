          ...
          <table className="w-full border-collapse">
            <tbody>
              {terms.map((term, index) => (
                <tr key={index}>
                  <td className="border border-slate-600 px-4 py-5 bg-slate-800" style={{ padding: '18px 16px' }}>
                    <div className="space-y-1">
                      <div className="font-bold text-blue-800 capitalize" style={{ fontWeight: 'bold', color: '#1e40af' }}>{term.term}</div>
                  ...
                  <td className="border border-slate-600 px-4 py-5 text-center bg-slate-800" style={{ width: '200px', padding: '18px 16px' }}>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <Button
              ...
              className="text-white font-semibold rounded-full shadow-lg transform hover:scale-105 transition-all duration-200"
              style={{
