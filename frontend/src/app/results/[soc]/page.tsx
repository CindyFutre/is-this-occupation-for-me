          ...
          <table className="w-full border-collapse">
            <tbody>
              {terms.map((term, index) => (
                <tr key={index}>
                  <td className="border border-slate-600 px-4 py-4 bg-slate-800">
                    <div className="space-y-1">
                      <div className="font-bold text-slate-100 capitalize" style={{ fontWeight: 'bold' }}>{term.term}</div>
                  ...
                  <td className="border border-slate-600 px-4 py-4 text-center bg-slate-800" style={{ width: '200px' }}>
