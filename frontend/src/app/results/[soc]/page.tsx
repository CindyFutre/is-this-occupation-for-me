      ...
      <CardContent>
        <div className="space-y-3">
          {terms.map((term, index) => (
            <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-slate-700 hover:bg-slate-600 transition-colors">
              ...
              <Badge className={`ml-3 ${colorClass} text-white font-semibold`}>
                {term.count}
              </Badge>
            </div>
          ))}
